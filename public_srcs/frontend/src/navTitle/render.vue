  ...
  <div class="scottstudio-navtitle">
    ...
    <div class="favlinks_container">
      <div class="favlinks_title">
        ...
        <div class="favlinks_dynamic_bar"></div>
      </div>
    </div>
  </div>
</template>
...
.scottstudio-navtitle .favlinks_title {
  font-weight: bold;
...
.scottstudio-navtitle .favlinks_container:hover {
